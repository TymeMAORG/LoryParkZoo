  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContainer}>
        <Text style={styles.title}>{formData.animalName} ({formData.species}) - Enclosure {formData.enclosure}</Text>
        <View style={styles.formSection}>
          ...
          <TextInput
            ...
            onChangeText={(text) => handleInputChange('foodOfferedQuantity', text)}
            keyboardType='numeric'
          />
          ...
          <Picker
            ...
            style={styles.input}
            onValueChange={(itemValue) => handleInputChange('foodType', itemValue)}
          >
          ...
          <TextInput
            style={[
              styles.input,
              { backgroundColor: formData.foodOfferedQuantity ? '#fff' : '#f0f0f0' }
            ]}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('regurgitating', isChecked)}
            fillColor="green"
            text="Regurgitating"
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('faeces', isChecked)}
            fillColor="green"
            text="Faeces"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('inBlue', isChecked)}
            fillColor="green"
            text="In Blue"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('shed', isChecked)}
            fillColor="green"
            text="Shedding"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('clean', isChecked)}
            fillColor="green"
            text="Clean"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('urine', isChecked)}
            fillColor="green"
            text="Urine"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
          ...
          <BouncyCheckbox
            ...
            onPress={(isChecked: boolean) => handleInputChange('water', isChecked)}
            fillColor="green"
            text="Water"
            iconStyle={{ borderColor: "green" }}
            innerIconStyle={{ borderWidth: 2 }}
